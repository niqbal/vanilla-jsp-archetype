<jsp:useBean id="project" scope="request" class="${package}.model.Project" ></jsp:useBean>
...
<tags:mainlayout>
	...
	<jsp:attribute name="breadcrumb"><a href="index.jsp">Home</a> / <a href="ProjectList">Projects</a> / ${dollar}{project.name}</jsp:attribute>
